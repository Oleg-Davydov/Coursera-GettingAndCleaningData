Codebook
========
Codebook was generated on 2014-09-21 16:53:02 during the same process that generated the dataset. See `run_analysis.md` or `run_analysis.html` for details on dataset creation.
...
```r
write.table( x = dtTidy, file = "tidyDataSet.txt", row.names = FALSE)
```
